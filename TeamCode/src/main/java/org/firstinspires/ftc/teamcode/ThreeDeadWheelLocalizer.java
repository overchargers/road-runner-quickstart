...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2950.1534970580688; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2792.9894763123657; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2128.4689537718764; // x position of the perpendicular encoder (in tick units)
    }
