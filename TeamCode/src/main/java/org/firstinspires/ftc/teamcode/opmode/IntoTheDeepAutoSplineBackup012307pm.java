...
@Config
@Autonomous(name = "IntoTheDeepAutoSplineBackup", group = "Into The Deep")
@Disabled
public class IntoTheDeepAutoSplineBackup012307pm extends LinearOpMode {
...
//                            )
//            );
            Action trajectoryAction1 = drive.actionBuilder(drive.pose, Constants.maxWheelVel-15, Constants.maxProfileAccel-15)
//                    .strafeTo(new Vector2d(-2, 0))
//                    .setTangent(Math.toRadians(-90))
//                    .lineToY(30)
            ...
            Action trajectoryAction3 = drive.actionBuilder(drive.pose, Constants.maxWheelVel+20, Constants.maxProfileAccel+30)
...
////            // @formatter:off
            ...
            Action trajectoryAction6 = drive.actionBuilder(drive.pose, Constants.maxWheelVel, Constants.maxProfileAccel)
                    .splineToLinearHeading(new Pose2d(-3, 28.4, Math.toRadians(-87)), Math.toRadians(0))
...
//                    .splineToLinearHeading(new Pose2d(8,20,Math.toRadians(0)),Math.toRadians(90))
            ...
            Action trajectoryAction19 = drive.actionBuilder(drive.pose, Constants.maxWheelVel, Constants.maxProfileAccel)
                    .splineToLinearHeading(new Pose2d(-8,28,Math.toRadians(-88)),Math.toRadians(90))
                    .build();
            // @formatter:on
